...
export function intersectsPoint( line3, v3, tolerance ) {
	...
	const AB = Math.sqrt( ( line3[ 0 ] - line3[ 3 ] ) ** 2 + ( line3[ 1 ] - line3[ 4 ] ) ** 2 + ( line3[ 2 ] - line3[ 5 ] ) ** 2 )
	const AP = Math.sqrt( ( line3[ 0 ] - v3[ 0 ] ) ** 2 + ( line3[ 1 ] - v3[ 1 ] ) ** 2 + ( line3[ 2 ] - v3[ 2 ] ) ** 2 )
	const BP = Math.sqrt( ( line3[ 3 ] - v3[ 0 ] ) ** 2 + ( line3[ 4 ] - v3[ 1 ] ) ** 2 + ( line3[ 5 ] - v3[ 2 ] ) ** 2 )
